...
def main(t_values, target, yawt):
    ...
    for t in t_values:
        ...
        x_from_base = xyz[a,0]
        y_from_base = xyz[a,1]
        z_from_base = xyz[a,2] + 0.16

        yaw = yawt[a,1]
        
        f_target = kdl.Frame(kdl.Rotation.RPY(0, 0, yaw), kdl.Vector(x_from_base, y_from_base, z_from_base - 0.16))
...
points_set_1 = a([[0, 0.105, -0.8], [0, 0.105, -0.69], [0, 0.105, -0.672], [0, 0.105, -0.672]])
